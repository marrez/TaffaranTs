...
export const GameBoard = ({ 
  ...
  return (
    <div className="relative w-full max-w-4xl mx-auto px-2 landscape-phone:px-0 landscape-phone:w-full landscape-phone:h-full landscape-phone:flex landscape-phone:items-center landscape-phone:justify-center">
      ...
      <div className="relative rounded-full w-full aspect-square max-w-[280px] sm:max-w-md md:max-w-2xl mx-auto p-4 sm:p-8 md:p-12
                      ...
                      landscape-phone:aspect-[3/1] landscape-phone:h-full landscape-phone:w-auto landscape-phone:max-w-[90%] landscape-phone:p-2 landscape-phone:rounded-xl landscape-phone:min-h-0"
        style={{
      ...
      >
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-center z-10">
          <div className="px-2 sm:px-4 md:px-6 py-1 sm:py-2 md:py-3 landscape-phone:px-1.5 landscape-phone:py-0.5 bg-primary/10 backdrop-blur-md text-primary-foreground rounded-full text-xs sm:text-sm md:text-lg landscape-phone:text-[8px] font-bold shadow-lg mb-1 sm:mb-2 landscape-phone:mb-0 whitespace-nowrap">
            {currentContract}
          </div>
          {trick.length === 0 && (
          ...
          return (
            <div
              ...
              className={cn(
                ...
                'landscape-phone:px-1.5 landscape-phone:py-0.5 landscape-phone:text-[9px] landscape-phone:font-bold',
                'landscape-phone:bg-card landscape-phone:shadow-lg landscape-phone:border',
                isBottom && 'landscape-phone:!bottom-0.5 landscape-phone:!left-1/2 landscape-phone:!-translate-x-1/2 landscape-phone:!translate-y-0 landscape-phone:!mt-0',
                isLeft && 'landscape-phone:!left-0.5 landscape-phone:!top-1/2 landscape-phone:!-translate-y-1/2 landscape-phone:!-translate-x-0 landscape-phone:!mr-0',
                isTop && 'landscape-phone:!top-0.5 landscape-phone:!left-1/2 landscape-phone:!-translate-x-1/2 landscape-phone:!-translate-y-0 landscape-phone:!mb-0',
                isRight && 'landscape-phone:!right-0.5 landscape-phone:!top-1/2 landscape-phone:!-translate-y-1/2 landscape-phone:!translate-x-0 landscape-phone:!ml-0',
                // State-based styling
            ...
            >
              <div className="text-center whitespace-nowrap">
                <p className={cn(
                  'font-bold landscape-phone:text-[8px]',
